function draggable_init() {
   ...
   ndRegister(Event.MOUSE_LEFT_DOWN, function (event, node, x, y) {
      space.grab = true;
   ...
   ndRegister(Event.MOUSE_LEFT_UP, function (event, node, x, y) {
      if (space.grab) {
         space.grab = false;
         ndReleaseMouse(this);
      }
   ...
   ndRegister(Event.MOUSE_MOVE, function (event, node, x, y) {
      if (space.grab) {
