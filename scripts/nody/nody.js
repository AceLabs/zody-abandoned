...
function ndNew(parent, id) {
   var node = {
      id: id, nudgeX: 0, nudgeY: 0, paddingX: 0, paddingY: 0, clipped: true, parent: null, kids: [], clipPadding: 0, _x: 0, _y: 0, _w: 0, _h: 0, _active: true, borderColor: [1, 1, 1], color: [1, 1, 1], text: null, textColor: [1, 1, 1], textX: 0, textY: 0, fontName: 'courier', fontStyle: 'default', fontSize: 10
